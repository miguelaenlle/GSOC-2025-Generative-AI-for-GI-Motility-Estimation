...
Key Functions:
    ...
    - `SinGAN_generate(...)`: Generates synthetic images using the trained SinGAN model across scales.
...
# THIS is where you change num_samples parameter
def SinGAN_generate(Gs,Zs,reals,NoiseAmp,opt,in_s=None,scale_v=1,scale_h=1,n=0,gen_start_scale=0,num_samples=25):
