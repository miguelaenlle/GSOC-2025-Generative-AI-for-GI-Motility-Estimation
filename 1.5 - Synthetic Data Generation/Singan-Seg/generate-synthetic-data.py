...
def synthetic_data_generation(n_samples=50):
    input_dir = "/home/miguel/GI/0 - Data Exploration & Analysis/GI-Roberta/gi-roberta-dataset/full_dataset_rgba"
    ...
    for img in images:
        ...
        python_command = f"python main_train.py --input_name '{img_name}' --input_dir='{input_dir}' --nc_z 4 --nc_im 4 --gpu_id 0"
...
synthetic_data_generation(n_samples=1000)
